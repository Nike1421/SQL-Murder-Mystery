...
con = sql.connect(
    os.path.abspath('./sqlGameBackend/sql-murder-mystery.db'), check_same_thread=False)
queries = [
    '''
SELECT *
...
class GameBackend(Resource):
    def post(self):
        try:
            ...
            if os.path.isfile(os.path.abspath('./sqlgame/src/output.png')):
                os.remove(
                    os.path.abspath('./sqlgame/src/output.png'))
            dfi.export(queryResult, os.path.abspath('./sqlgame/src/output.png'),
